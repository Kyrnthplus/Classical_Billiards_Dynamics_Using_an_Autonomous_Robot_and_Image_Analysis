...
for Nome in arquivos:
    ...
    # Plot 1: Trajectory
    plt.subplot(2, 2, 1)
    plt.plot(XT[::10000], YT[::10000], color=CORT, linestyle='solid', drawstyle='default', linewidth=1,alpha=0.5)

    plt.plot(X[::100], Y[::100], color=COR, linestyle='solid', drawstyle='default', linewidth=1)
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.axis('square')
    plt.ylim(-1.51, 1.51)
    ...
    plt.subplot(2, 2, 2)
    plt.plot(X_CT, Y_CT, color=CORT, linestyle='none', drawstyle='default', linewidth=1, marker='.', markersize=10, markeredgecolor='black',alpha=0.5)
    ...
    plt.plot(LxT, LyT, color=CORT,alpha=0.5)
