...
gamma = int(input('Insira o valor do Gamma(5 digito): '))# 0.5624
COUNT = int(input('Insira a quantidade de colisões por simulação: '))
Gamma=float(gamma/100000)
...
for k in range(Simu):
    ...
    data_hora_formatada = agora.strftime("%Y-%m-%d")#agora.strftime("%Y-%m-%d_%H-%M-%S")
    N=k+1
