...
for Nome in arquivos:
    ...
    plt.tight_layout()
    plt.savefig('Gráficos/Poincaré/Solo/png/' + str(nome_arquivo) + '_(Comp_Poincare_Solo).png', dpi=600)
    plt.savefig('Gráficos/Poincaré/Solo/pdf/' + str(nome_arquivo) + '_(Comp_Poincare_Solo).pdf', dpi=600)
    plt.savefig('Gráficos/Poincaré/Solo/svg/' + str(nome_arquivo) + '_(Comp_Poincare_Solo).svg', dpi=600)
    #plt.show()
