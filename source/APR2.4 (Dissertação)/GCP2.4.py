...
for Nome in arquivos:
    ...
    ax.plot(X_PT, Y_PT, color='gray', linestyle='none', drawstyle='default', linewidth=1, marker='.', markersize=6, alpha=0.75) #, label='Numerical')
    ...
    # Salvar o gráfico
    plt.savefig('Gráficos/SP/Poincaré/' + str(nome_arquivo) + '_(Comp_Poincaré).png', dpi=200)
